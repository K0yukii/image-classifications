...
"""## Ссылка на обученную модель и порядок запуска с другого аккаунта

* https://drive.google.com/drive/folders/1sZ8Jk5-IpEgnGDaCWcoIb3Sr3SaVoguF?usp=sharing

* Требуется скачать архив с папкой "model_V2" по ссылке выше.

* разархивировать ее.

* Загрузить ее на свой гугл диск

* Запускать код с заголовка "Загрузка модели с гугл диска", по "Результат тестового набора"

## Список использованных источников

*   [Что такое нейронные сети,
что они могут, и как написать нейронную сеть на Python?
](https://neural-university.ru/neural-networks-basics#rec116238488)
...
*   [Batch Normalization для ускорения обучения нейронных сетей](https://habr.com/ru/articles/309302/)
"""